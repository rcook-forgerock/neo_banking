...
import 'package:neo_banking/data/model/balance_model.dart';
import 'package:neo_banking/data/model/bank_model.dart';
...
class Repository {
  ...
  Future<List<Transactions>> getTransactions() async {
    final String response = await rootBundle.loadString(
      'lib/assets/json/transaction.json',
    );
